...
import type {
	PortfolioFundHoldingEntry as _proto_PortfolioFundHoldingEntry,
	PortfolioFundHoldingEntry__Output as _proto_PortfolioFundHoldingEntry__Output
} from '../proto/PortfolioFundHoldingEntry';
