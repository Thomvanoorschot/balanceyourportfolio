...
<div class="relative w-full">
    <div>
        <button
                ...
                type="button"
                class="flex items-center outline-none bg-secondary w-full text-center rounded-xl border-2 border-primary {isActive ? 'border-quaternary' : ''} pt-2 pb-2"
        >
    ...
    {#if (isActive)}
        <div class="absolute w-full"
             use:clickOutside on:click_outside={() => isActive = !isActive}
        >
