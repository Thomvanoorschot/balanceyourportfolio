<script lang="ts">
    ...
    import {toggleTheme} from "$lib/shared/theme.ts";
    ...
    onMount(() => {
        ...
        if (!('theme' in localStorage)) {
            ...
            theme.useLocalStorage();
            localTheme = $theme.mode
        }
    });
</script>

<div id="core" class="flex flex-col min-h-screen {localTheme}">
    ...
    <!--            <div class="ml-3 border-solid border-2 rounded border-sky-500 p-2 hover:bg-sky-200" >Signup</div>-->
    <!--        </div>-->
    <!--    </header>-->
    ...
    <footer class="bg-white text-center">
        <div class="p-4 text-center text-neutral-800">
            © 2023 Copyright:
