...
<div class="flex flex-grow items-center justify-center w-full">
    <div class="bg-white shadow-md rounded-lg p-3 w-[50vw]">
        <div class="flex relative flex-col items-center bg-gray-200 rounded-xl w-full">
            <div class="flex w-full items-center">
                ...
                >
                    <input
                            name="searchTerm"
                            on:input={search}
                            class="w-full rounded-xl bg-gray-200 text-gray-700 leading-tight focus:outline-none py-2 px-2"
                            type="search"
