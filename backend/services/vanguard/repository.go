...
type Repository interface {
	...
	UpsertFigiMapping(ctx context.Context, s []model.FigiMapping, tx pgx.Tx) error
	GetFigiMappings(ctx context.Context) (map[string]model.FigiMapping, map[string]model.FigiMapping, error)
}
