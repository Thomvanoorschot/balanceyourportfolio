...
import type { PortfolioFundSectorWeightingEntry as _proto_PortfolioFundSectorWeightingEntry, PortfolioFundSectorWeightingEntry__Output as _proto_PortfolioFundSectorWeightingEntry__Output } from '../proto/PortfolioFundSectorWeightingEntry';
